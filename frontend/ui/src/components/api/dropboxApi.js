...
export function postSyncTask(startTask, selectedPaths, fileTypes, ignore, pathCategories) {
  const payload = {
    paths: selectedPaths,
  ...
  return startTask(`${CONSTANTS.API_BASE_URL}/${CONSTANTS.DROPBOX_BASE}/sync`, {
    method: 'POST',
    body: payload
  })
}
